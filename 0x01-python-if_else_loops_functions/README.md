Python Project if else loops functions

In this project we consider conditional statements and thier uses in Python.The follosing objectives must be met upon completing this project:
...
Below is a video explaining conditional statements used in Python:
https://youtu.be/5-5Mf_L0UKw:
